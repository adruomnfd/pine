...
void Profiler::Finalize() {
    ...
    //     pstd::sort(sorted.begin(), sorted.end(),
    ...
    //         else if (pstd::find(parents.begin(), parents.end(), rec.second->name) ==
    //         parents.end())
...
void SampledProfiler::Finalize() {
    ...
    // pstd::sort(phaseStat.begin(), phaseStat.end(),
